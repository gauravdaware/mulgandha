        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
					...
					<?php
							if(isset($search)){
								$sql_qry="select * from fk_categories_tbl where category_name like '$searchstr%'";
							}
							else if(isset($delete)){
								$sql_qry = "select * from fk_categories_tbl where trash = 1";
							}
							else
								$sql_qry="select * from fk_categories_tbl where trash = 0";
					...
					?>
						<tr>
							...
							<td>
							  ...
							  {
							  ?>
							  <a style="color:orange;border-bottom:1px solid;" href="cat_action.php?asid=<?php echo $row['category_id'];?>">In-Active</a>
							  <?php
							  }
							  else
							  {
								  ?>
									<a style="color:blue;border-bottom:1px solid;" href="cat_action.php?sid=<?php echo $row['category_id'];?>">Active</a>
								  <?php
							  }
							  ?>
							  <a style="color:red;border-bottom:1px solid;" href="delete_categories.php?dsid=<?php echo $row['category_id'];?>" onclick="return confirm('Are you sure to delete?')">Delete</a>
							  </td>
                          </tr>							
						<?php
						$i++;
