                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Remove Slider</li>
                        </ol>
                    </div>
                </div>
            </div>
						 ...
						 if(empty($searchstr))
						  ...
						  ?>
                            <tr>
								...
								<td>
									<img src="<?php echo '../uploads/slider/'.$row['slider_image'];?>" border="1px solid" height="50px" width="60px" style="border-radius:10px; box-shadow: 0 0 10px green;">
								</td>
							  ...
							  ?>
								...
								<td>
								  <a style="color:red; border-bottom:1px solid;" href="db_delete_slider.php?sid=<?php echo $row['slider_id'];?>" onclick="return confirm('Are you sure to delete?')">Delete</a>
								  <a style="color:blue; border-bottom:1px solid;" href="restore_slider.php?sid=<?php echo $row['slider_id'];?>" onclick="return confirm('Are you sure to Re-store?')">Re-store</a>
							   </td>
                          </tr>
						  <?php
						  $i++;
