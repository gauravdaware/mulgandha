...
if(empty($_SESSION['email'])){
	...
	if(isset($search))
{
	$sql_qry="select s.*,c.category_name from fk_sub_categories_tbl s inner join fk_categories_tbl c on s.category_id=c.category_id  where s.sub_category_name like '$searchstr%' and trash=0";
}
?>
<!doctype html>
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-lg-12">
					...
					<?php
						  ...
						  if(empty($searchstr))
						  {
						  $sql_qry="select s.*,c.category_name from fk_sub_categories_tbl s inner join fk_categories_tbl c on s.category_id=c.category_id where s.trash=0";
						  }
						  ...
						  ?>
                            <tr>
							  ...
							  {
							  ?>
							  <a style="color:orange;border-bottom:1px solid;" href="sub_action.php?asid=<?php echo $row['sub_category_id'];?>">In-Active</a>
							  <?php
							  }
							  else
							  {
								  ?>
									<a style="color:blue; border-bottom:1px solid;" href="sub_action.php?sid=<?php echo $row['sub_category_id'];?>">Active</a>
								  <?php
							  }
							  ?>
							  <a style="color:red; border-bottom:1px solid;" href="delete_subcategories.php?sid=<?php echo $row['sub_category_id'];?>" onclick="return confirm('Are you sure to delete?')">Delete</a>
							  </td>
                          </tr>
						  <?php
						  $i++;
