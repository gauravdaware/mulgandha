...
if(empty($_SESSION['email'])){
	...
	if(isset($search))
{
	$sql_qry="select * from fk_coupons_tbl where coupon_code like '$searchstr%' and trash=1";
}
?>
<!doctype html>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Removed Coupons</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
					...
					<form method="post" action="" style="background-color: #f7f7f7;">
                        ...
                        <div class="card-header">
                            <strong class="card-title">Removed Coupons</strong>
                        </div>
                        <div class="card-body">
                            <table class="table">
						 ...
						 if(empty($searchstr))
						  ...
						  ?>
							...
							<td><?php echo $row['added_on'];?> </td>
                               <td>
								  <a style="color:red; border-bottom:1px solid;" href="db_delete_coupons.php?sid=<?php echo $row['coupon_id'];?>" onclick="return confirm('Are you sure to delete?')">Delete</a>
								  <a style="color:blue; border-bottom:1px solid;" href="restore_coupons.php?sid=<?php echo $row['coupon_id'];?>" onclick="return confirm('Are you sure to Re-store?')">Re-store</a>
							   </td>
                          </tr>
						  <?php
						  $i++;
