...
if(empty($_SESSION['email'])){
	...
	if(isset($search))
{
	$sql_qry="select * from fk_categories_tbl where category_name like '$searchstr%' and trash=1";
}
?>
<!doctype html>
						  ...
						  ?>
                            <tr>
							  ...
							  <td><?php echo $row['created_on'];?></td>
                               <td>
								  <a style="color:red; border-bottom:1px solid;" href="db_delete_categories.php?sid=<?php echo $row['category_id'];?>" onclick="return confirm('Are you sure to delete?')">Delete</a>
								  <a style="color:blue; border-bottom:1px solid;" href="restore_categories.php?sid=<?php echo $row['category_id'];?>" onclick="return confirm('Are you sure to Re-store?')">Re-store</a>
							   </td>
                          </tr>
						  <?php
						  $i++;
